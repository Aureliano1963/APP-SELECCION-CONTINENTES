...
public class CheckEuropa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_europa);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CheckEuropa.this, Continentes.class);
    ...
    class Adaptadorpersonas extends ArrayAdapter<csAmerica>
    {
        ...
        Adaptadorpersonas (AppCompatActivity context ){
            super(context,R.layout.activity_check_europa,listaPaises);
