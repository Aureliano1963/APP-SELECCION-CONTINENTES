...
public class CheckOceania extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_oceania);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CheckOceania.this, Continentes.class);
    ...
    class Adaptadorpersonas extends ArrayAdapter<csAmerica>
    {
        ...
        Adaptadorpersonas (AppCompatActivity context ){
            super(context,R.layout.activity_check_oceania,listaPaises);
    ...
    public void Validar(){
        ...
        if(rd5.isChecked()==true){
            t5.setText("Wellington");
        }
        if(rd6.isChecked()==true){
            t6.setText("Port Moresby");
        }
